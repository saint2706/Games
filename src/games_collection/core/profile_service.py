"""High-level helpers for working with :class:`~games_collection.core.profile.PlayerProfile` instances.
...
from games_collection.core.profile import PlayerProfile, get_default_profile_dir, load_or_create_profile
