...
from games_collection.games.card.war.cli import STATS_AVAILABLE, game_loop
...
try:  # pragma: no cover - import may fail when Tkinter is unavailable
    from games_collection.games.card.war.gui import run_app as run_gui_app
...
def main() -> None:
    ...
    if args.pyqt:
        try:
            from games_collection.games.card.war.gui_pyqt import run_gui as run_pyqt_gui
