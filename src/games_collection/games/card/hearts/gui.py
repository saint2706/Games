...
Accessibility is handled through :class:`~games_collection.core.gui_base.GUIConfig` so that high
...
class HeartsGUI(BaseGUI):
    ...
    def __init__(
        ...
        *,
        ...
        self._preferences_namespace = "games_collection.games.card.hearts.gui"
