...
games_collection.games.card.hearts`` mirrors the behaviour of the standalone GUI launcher.
"""
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    if backend == "pyqt":
        try:
            from games_collection.games.card.hearts.gui_pyqt import run_app as run_app_pyqt
    ...
    try:
        from games_collection.games.card.hearts.gui import run_app as run_app_tk
