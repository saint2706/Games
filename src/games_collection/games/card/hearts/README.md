...
- Run `python -m games_collection.games.card.hearts --high-contrast` for a high-contrast palette.
- Run `python -m games_collection.games.card.hearts --accessibility-mode` to enable large fonts, screen-reader labelling, and focus
  indicators.
...
```bash
python -m games_collection.games.card.hearts --cli
```
