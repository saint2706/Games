...
python -m games_collection.games.card.uno --custom-deck decks/rainbow.json

# Create a new deck
python -m games_collection.games.card.uno.deck_designer

# Validate a deck file
python -m games_collection.games.card.uno.validate_deck decks/extreme.json
```
