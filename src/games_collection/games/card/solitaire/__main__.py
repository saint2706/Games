...
from games_collection.games.card.solitaire.cli import game_loop
from games_collection.games.card.solitaire.game import SolitaireGame
from games_collection.games.card.solitaire.gui import run_app as run_app_tk

try:  # pragma: no cover - Optional dependency import
    from games_collection.games.card.solitaire import gui_pyqt as gui_pyqt_module
