...
from games_collection.games.card.pinochle.cli import main as cli_main
from games_collection.games.card.pinochle.gui import run_app as run_tk_app
...
def _launch_pyqt(names: Sequence[str] | None) -> bool:
    try:
        from games_collection.games.card.pinochle.gui_pyqt import run_app as run_pyqt_app
