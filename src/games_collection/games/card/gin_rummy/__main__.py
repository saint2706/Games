...
from games_collection.games.card.gin_rummy.cli import game_loop
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    if args.mode == "gui":
        from games_collection.games.card.gin_rummy.gui import run_app
    ...
    if args.mode == "pyqt":
        try:
            from games_collection.games.card.gin_rummy.gui_pyqt import run_pyqt_app
