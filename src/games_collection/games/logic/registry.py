...
def register_default_logic_games() -> None:
    ...
    LOGIC_PUZZLE_SERVICE.register_puzzle(
        LogicPuzzleDefinition(
            game_key="games_collection.games.logic.minesweeper",
    ...
    LOGIC_PUZZLE_SERVICE.register_puzzle(
        LogicPuzzleDefinition(
            game_key="games_collection.games.logic.picross",
    ...
    LOGIC_PUZZLE_SERVICE.register_puzzle(
        LogicPuzzleDefinition(
            game_key="games_collection.games.logic.sliding_puzzle",
    ...
    LOGIC_PUZZLE_SERVICE.register_puzzle(
        LogicPuzzleDefinition(
            game_key="games_collection.games.logic.lights_out",
    ...
    LOGIC_PUZZLE_SERVICE.register_puzzle(
        LogicPuzzleDefinition(
            game_key="games_collection.games.logic.sokoban",
