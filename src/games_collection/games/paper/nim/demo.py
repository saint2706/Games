...
from games_collection.games.paper.nim import NimGame, NorthcottGame, WythoffGame
...
def main():
    ...
    print("=" * 70)
    print("\nTo play interactively, run: python -m games_collection.games.paper.nim")
    print("For more information, see: src/games_collection/games/paper/nim/README.md")
    print()
