...
def demo_network_multiplayer():
    ...
    print("\n1. HOST MODE:")
    print("   python -m games_collection.games.paper.dots_and_boxes --host --size 4 --name 'Alice'")
    ...
    print("\n2. CLIENT MODE:")
    print("   python -m games_collection.games.paper.dots_and_boxes --join localhost --name 'Bob'")
...
def main():
    ...
    print("  • GUI mode:        python -m games_collection.games.paper.dots_and_boxes --gui --size 5 --hints")
    print("  • Tournament:      python -m games_collection.games.paper.dots_and_boxes --tournament 5 --size 4")
    print("  • Host multiplayer: python -m games_collection.games.paper.dots_and_boxes --host --size 3 --name You")
    print("  • Join multiplayer: python -m games_collection.games.paper.dots_and_boxes --join localhost --name Friend")
    print("\n" + "=" * 60 + "\n")
