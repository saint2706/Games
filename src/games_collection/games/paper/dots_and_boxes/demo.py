...
def run_all_demos() -> None:
    ...
    print("  CLI:        python -m games_collection.games.paper.dots_and_boxes --size 4")
    print("  GUI:        python -m games_collection.games.paper.dots_and_boxes --gui --hints")
    print("  Tournament: python -m games_collection.games.paper.dots_and_boxes --tournament 3")
    print("  Multiplayer:")
    print("    Host:     python -m games_collection.games.paper.dots_and_boxes --host")
    print("    Join:     python -m games_collection.games.paper.dots_and_boxes --join localhost")
    print()
