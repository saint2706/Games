...
def launch_game(choice: str) -> bool:
    ...
    game_map: dict[str, tuple[str, Callable[[], None]]] = {
        ...
        "13": ("tic_tac_toe", lambda: __import__("paper_games.tic_tac_toe.__main__", fromlist=["main"]).main()),
        "14": ("battleship", lambda: __import__("paper_games.battleship.__main__", fromlist=["main"]).main()),
        "15": ("checkers", lambda: __import__("paper_games.checkers.__main__", fromlist=["main"]).main()),
        "16": ("connect_four", lambda: __import__("paper_games.connect_four.__main__", fromlist=["main"]).main()),
        "17": ("othello", lambda: __import__("paper_games.othello.__main__", fromlist=["main"]).main()),
        "18": ("dots_and_boxes", lambda: __import__("paper_games.dots_and_boxes.__main__", fromlist=["main"]).main()),
        "19": ("hangman", lambda: __import__("paper_games.hangman.__main__", fromlist=["main"]).main()),
        "20": ("nim", lambda: __import__("paper_games.nim.__main__", fromlist=["main"]).main()),
        "21": ("sudoku", lambda: __import__("paper_games.sudoku.__main__", fromlist=["main"]).main()),
        "22": ("mancala", lambda: __import__("paper_games.mancala.__main__", fromlist=["main"]).main()),
        "23": ("craps", lambda: __import__("dice_games.craps.__main__", fromlist=["main"]).main()),
        "24": ("bunco", lambda: __import__("dice_games.bunco.__main__", fromlist=["main"]).main()),
        "25": ("liars_dice", lambda: __import__("dice_games.liars_dice.__main__", fromlist=["main"]).main()),
        "26": ("unscramble", lambda: __import__("word_games.unscramble.__main__", fromlist=["main"]).main()),
        "27": ("wordle", lambda: __import__("word_games.wordle.__main__", fromlist=["main"]).main()),
        "28": ("mastermind", lambda: __import__("logic_games.mastermind.__main__", fromlist=["main"]).main()),
        "29": ("codebreaker", lambda: __import__("logic_games.codebreaker.__main__", fromlist=["main"]).main()),
    }
